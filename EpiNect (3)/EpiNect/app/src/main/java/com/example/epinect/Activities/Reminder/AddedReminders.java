...
public class AddedReminders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ReminderAdapter(this,reminderList); // Pass reminderList to the adapter
    ...
    private void initializeFloatingPopup() {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddedReminders.this,ReminderMain.class);
    ...
    private void handleTimeSelection() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(AddedReminders.this,
    ...
    // Read data from the database and log it
